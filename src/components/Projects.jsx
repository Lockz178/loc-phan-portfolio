...
const projects = [
  ...
  },
  {
    ...
    title: 'Raft KV Store',
    desc: 'A distributed, fault-tolerant key-value store implementing the Raft consensus algorithm from scratch in pure Go, with zero dependencies. Handles leader election, log replication, and snapshotting while staying consistent through node crashes and network partitions. Ships with a live cluster dashboard, REST API, a raftctl CLI, and a one-command 5-node Docker cluster.',
    highlights: [
      'Raft consensus from scratch',
      'Survives crashes & partitions',
      'Live 5-node Docker cluster',
    ],
