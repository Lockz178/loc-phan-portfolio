        ...
        <div className="about-text">
          ...
          <FadeIn delay={0.15}>
            <p className="body-text">
              I'm <strong>Phan Ngoc Phuoc Loc</strong>, a software engineering
              student at Tampere University of Applied Sciences in Finland,
              originally from Vietnam. I moved to Finland to study and build a
              career in tech, expected to graduate in 2028.
            </p>
            <p className="body-text">
              ...
              server administration for deployment. I enjoy solving real
              problems with clean, practical code.
            </p>
          </FadeIn>
          ...
          <FadeIn delay={0.35}>
            <div className="about-links">
              ...
              <a href="/cv.pdf" className="btn-pill-sm" download>
                Download CV
              </a>
            </div>
          </FadeIn>
