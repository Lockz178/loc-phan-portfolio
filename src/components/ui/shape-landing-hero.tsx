 ...
 *  inside ScrollExpandMedia (fades out as the video expands). */
export function GeometricBackground() {
  return (
    <>
      {/* Ambient glow — blue/purple to match portfolio accent */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-600/[0.07] via-transparent to-violet-600/[0.07] blur-3xl" />
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div custom={1} variants={fadeUp} initial="hidden" animate="visible">
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
              ...
              <br />
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-300 via-white/90 to-violet-300">
                {title2}
              </span>
            </h1>
          </motion.div>
