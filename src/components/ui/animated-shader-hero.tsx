  ...
  return (
    <div className={`relative w-full h-screen overflow-hidden bg-black ${className}`}>
      <style>{`
        ...
        .shader-anim-down { animation: shader-fade-down 0.8s ease-out forwards; }
        .shader-anim-up   { animation: shader-fade-up 0.8s ease-out forwards; opacity: 0; }
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white px-4">
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto">
          ...
          <p
            className="text-orange-100/80 font-light leading-relaxed max-w-2xl mx-auto shader-anim-up shader-delay-600"
          ...
          {buttons && (
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8 shader-anim-up shader-delay-800">
              {buttons.primary && (
                <button
